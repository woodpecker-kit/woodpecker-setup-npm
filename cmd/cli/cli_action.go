...
import (
	...
	"github.com/woodpecker-kit/woodpecker-setup-npm/constant"
	"github.com/woodpecker-kit/woodpecker-setup-npm/internal/pkg_kit"
	"github.com/woodpecker-kit/woodpecker-setup-npm/internal/version_check"
...
var wdPlugin *setup_npm_plugin.Plugin
...
func GlobalBeforeAction(c *cli.Context) error {
	...
	pluginBind, errBindPlugin := setup_npm_plugin.BindCliFlags(c,
		isDebug,
