# This dockerfile uses extends image https://hub.docker.com/woodpecker-kit/woodpecker-setup-npm
# VERSION 1
...
ARG GO_ENV_ROOT_BUILD_BIN_NAME=woodpecker-setup-npm
ARG GO_ENV_ROOT_BUILD_BIN_PATH=build/${GO_ENV_ROOT_BUILD_BIN_NAME}
ARG GO_ENV_ROOT_BUILD_ENTRANCE=cmd/woodpecker-setup-npm/main.go
...
ENTRYPOINT [ "/app/woodpecker-setup-npm" ]
# CMD ["/app/woodpecker-setup-npm", "--help"]